...
const DeletePluModal: React.FC<DeletePluModalProps> = ({ isOpen, onClose, onConfirm, scale }) => {
 ...
 <button type="button"onClick={onClose} className="p-1 text-slate-600 hover:text-slate-600 dark:hover:text-slate-300 rounded-lg">
 <X size={20} />
 </button>
 </div>
 ...
 type="button"
 onClick={onClose}
 className="px-4 py-2 text-slate-700 bg-slate-100 hover:bg-slate-200 dark:text-slate-300 dark:bg-slate-700 dark:hover:bg-slate-600 rounded-lg font-medium"
 >
