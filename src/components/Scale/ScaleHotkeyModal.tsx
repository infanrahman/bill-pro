...
const ScaleHotkeyModal: React.FC<ScaleHotkeyModalProps> = ({ scale, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-7xl h-[90vh] flex flex-col overflow-hidden">
                {/* Header */}
                <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-700">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure physical hotkeys for {scale.name} ({scale.ipAddress})</p>
                    </div>
                        ...
                        <div className="grid grid-cols-7 gap-2">
                            {mappings.map((mapping) => (
                                <div
                                    ...
                                    className={`relative flex flex-col justify-center items-center h-20 rounded-lg border-2 cursor-pointer transition-all duration-200 ${selectedKeyIndex === mapping.keyIndex
                                        ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/40 shadow-[0_0_0_4px_rgba(99,102,241,0.2)]'
                                        : mapping.plu
                                            ? 'border-green-500/50 bg-white dark:bg-gray-800 hover:border-green-500 hover:shadow-md'
                                ...
                                >
                                    <span className="absolute top-1 left-2 text-xs font-semibold text-gray-400 dark:text-gray-500">
                                        {mapping.keyIndex}
                                    </span>
                                    {mapping.plu && (
                                        <button
                                    ...
                                    {mapping.plu ? (
                                        <div className="text-center px-2 mt-2">
                                            ...
                                            <p className="text-[10px] text-gray-500 mt-0.5 font-mono">PLU {mapping.plu}</p>
                                        </div>
                                    ) : (
                                        <span className="text-sm font-medium text-gray-400 dark:text-gray-500 mt-2">Empty</span>
                                    )}
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="p-4 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors disabled:opacity-50"
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-2">
                            {selectedKeyIndex === null ? (
                                <div className="h-full flex flex-col flex-1 items-center justify-center text-center px-6">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400">Click any key slot on the left to start assigning products.</p>
                                </div>
                                ...
                                filteredItems.map(item => (
                                    <button
                                        ...
                                        className="w-full text-left p-3 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-indigo-500 hover:shadow-md transition-all duration-200 group bg-white dark:bg-gray-800"
                                    >
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    <p className="text-sm font-mono text-gray-500 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded">
                ...
                <div className="p-6 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={onClose}
                            className="px-6 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-medium"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            disabled={isSaving}
                            className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-lg transition-colors flex items-center gap-2 font-medium"
                        >
                            <Save className={`${isSaving ? 'animate-spin' : ''} w-4 h-4`} />
