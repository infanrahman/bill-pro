...
`;
 ...
 <div className="bg-white border rounded w-[200px] p-3 flex flex-col items-center text-black">
 ...
 <p className="text-[11px] font-mono font-bold tracking-wider mt-0.5">{item.barcode ||`ID: ${item.id}`}</p>
)}
 </div>

 {/* Rotate code to the side as requested visually */}
 {showCostCode && costCode && (
 <p className="text-[10px] font-semibold tracking-wider text-slate-800 ml-2 opacity-70"style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>
 {costCode}
 </p>
)}
 </div>
 </div>
 <p className="text-xs text-slate-600 mt-4 text-center">Preview Layout<br />(Size varies based on label printer dimensions)</p>
 </div>
 ...
 className={`flex flex-col items-center justify-center flex-1 py-2 rounded-md text-xs font-medium ${format === 'linear' ? 'bg-white shadow pointer-events-none text-slate-900 dark:text-white dark:bg-slate-600 ' : 'text-slate-700 hover:text-slate-800 dark:text-slate-300'}`}
 >
 ...
 className={`flex flex-col items-center justify-center flex-1 py-2 rounded-md text-xs font-medium ${format === 'qr' ? 'bg-white shadow pointer-events-none text-slate-900 dark:text-white dark:bg-slate-600 ' : 'text-slate-700 hover:text-slate-800 dark:text-slate-300'}`}
 >
 ...
 <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Shop Size</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Name Size</span>
 <div className="flex gap-1">
 ...
 <div className="flex items-center justify-between">
 <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Price Size</span>
 <div className="flex gap-1">
 ...
 <button type="button"
 onClick={handlePrint}
 className="px-4 py-2 bg-slate-900 dark:bg-white text-white rounded-lg flex items-center gap-2 hover:bg-slate-900 dark:hover:bg-white"
 >
