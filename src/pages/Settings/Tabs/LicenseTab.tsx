            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className={`p-6 rounded-xl border ${getStatusColor()} flex items-start gap-4`}>
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-black mt-1 uppercase tracking-wider">{statusText}</p>
                        {status !== 'ok' && (
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <code className="block bg-slate-100 dark:bg-slate-900 p-3 rounded-lg font-mono text-sm border border-slate-200 dark:border-slate-700 select-all text-blue-600 dark:text-blue-400 break-all">
                            {machineId || 'Loading...'}
                        </code>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    {status !== 'ok' && (
                        <button
                            ...
                            className="px-6 py-3 bg-white text-blue-700 font-bold rounded-lg shadow hover:bg-blue-50 transition-colors whitespace-nowrap"
                        >
