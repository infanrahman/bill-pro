...
const ActivityLogTab: React.FC = () => {
 ...
 <p className="text-slate-700">Audit trail of user actions</p>
 </div>
 </div>
 ...
 <thead className="bg-slate-50 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs uppercase font-semibold">
 <tr>
 ...
 <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-300 truncate max-w-xs">
 {log.details || '-'}
 </td>
 </tr>
))}
