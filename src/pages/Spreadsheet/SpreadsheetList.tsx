        ...
        <div className="space-y-6 max-w-5xl mx-auto p-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">Manage your spreadsheets</p>
                </div>
                <button
            ...
            {spreadsheets.length === 0 ? (
                <div className="bg-white dark:bg-slate-800 rounded-xl border-dashed border-2 border-slate-300 dark:border-slate-700 p-12 text-center">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mb-6">Create your first spreadsheet to start organizing data.</p>
                    <button
                        onClick={() => onSelect('new')}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {spreadsheets.map((sheet: any) => (
                        <div
                            ...
                            className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:shadow-md transition-all cursor-pointer group"
                        >
