...
const SalesHistory: React.FC<SalesHistoryProps> = ({ onReturn }) => {
 ...
 <td className="p-6 font-bold text-slate-600 dark:text-slate-300 text-xs">{formatDate(inv.createdAt)}</td>
 <td className="p-6 font-semibold text-slate-800 dark:text-white uppercase text-xs tracking-tight">{inv.customerName}</td>
 <td className="p-6 font-semibold text-slate-900 dark:text-white text-sm">{formatCurrency(inv.grandTotal)}</td>
 <td className="p-4">
