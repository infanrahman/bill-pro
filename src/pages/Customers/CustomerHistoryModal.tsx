...
"text-lg font-semibold tracking-tight",
 ...
 {/* Tabs & Search Header */}
 <div className="p-4 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
 <div className="flex p-1 bg-slate-200 dark:bg-slate-800 rounded-xl w-full md:w-auto overflow-x-auto custom-scrollbar shrink-0">
 {[
 ...
 className={clsx(
 "flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-[9px] font-semibold uppercase tracking-wider whitespace-nowrap shrink-0 flex-1 md:flex-none",
 activeTab === tab.id 
 ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-indigo-400 shadow-sm' 
 : 'text-slate-700 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300'
 )}
 >
 <tab.icon size={14} />
 <span>{tab.label}</span>
