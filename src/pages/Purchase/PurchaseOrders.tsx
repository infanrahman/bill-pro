                        ...
                        {filteredPurchases?.map((po: any, rowIndex: any) => {
                            ...
                            return (
                                <tr key={po.id || po.orderNumber} className="hover:bg-slate-50/80 dark:hover:bg-slate-700/30 transition-colors group">
                                    ...
                                    <td {...getGridCellProps(rowIndex, 1)} data-label="Ref No" className="p-4 font-mono text-xs text-slate-500 dark:text-slate-400 outline-none focus:bg-blue-50 dark:focus:bg-blue-900/20 focus:ring-inset focus:ring-2 focus:ring-blue-500">{po.orderNumber}</td>
                                    ...
                                    <td {...getGridCellProps(rowIndex, 4)} data-label="Total" className={`p-4 font-bold text-sm outline-none focus:bg-blue-50 dark:focus:bg-blue-900/20 focus:ring-inset focus:ring-2 focus:ring-blue-500 ${activeTab === 'return' ? 'text-amber-600 dark:text-amber-400' : 'text-slate-800 dark:text-white'}`}>
                                        {formatCurrency(po.totalAmount)}
                                    </td>
                                    <td {...getGridCellProps(rowIndex, 5)} data-label="Status/Balance" className="p-4 flex-col md:flex-row md:items-center items-end gap-2 outline-none focus:bg-blue-50 dark:focus:bg-blue-900/20 focus:ring-inset focus:ring-2 focus:ring-blue-500">
                                        {activeTab === 'order' ? (
                                    ...
                                    <td {...getGridCellProps(rowIndex, 6)} data-label="Actions" className="p-4 text-right outline-none focus:bg-blue-50 dark:focus:bg-blue-900/20 focus:ring-inset focus:ring-2 focus:ring-blue-500 rounded-r-md">
