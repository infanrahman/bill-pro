...
const CashEntryModal: React.FC<CashEntryModalProps> = ({ isOpen, onClose, onSave, type, partyId, editEntry }) => {
 ...
 className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-900/75 backdrop-blur-md border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-mono text-lg font-bold outline-none"
 ...
 <div className="relative">
 <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-600"size={18} />
 <input
 type="date"
 value={date}
 ...
 <div className="relative">
 <Clock className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-600"size={18} />
 <input
 type="time"
 value={time}
 ...
 className="w-full p-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/75 backdrop-blur-md focus:ring-2 focus:ring-slate-900/20 dark:focus:ring-white/20 outline-none min-h-[100px] resize-none dark:text-white"
 ...
 <div className="relative">
 <Tag className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-600"size={18} />
 <input
 type="text"
 value={category}
 onChange={(e) => setCategory(e.target.value)}
 className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/75 backdrop-blur-md focus:ring-2 focus:ring-slate-900/20 dark:focus:ring-white/20 outline-none appearance-none dark:text-white"
 ...
 <button
 type="submit"
 className={`w-full py-3 rounded-xl text-white font-bold transform active:scale-95 flex justify-center items-center gap-2 ${isDisplayCashIn
