...
`Statement_${party.name}_${format(new Date(), 'yyyyMMdd')}`
 ...
 <button type="button"onClick={onBack} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full">
 ...
 className="p-2 bg-red-50 dark:bg-red-900/20 rounded-lg text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40"
 ...
 {/* Balance Card */}
 <div className={`p-6 rounded-2xl text-white ${balance >= 0 ? ' from-green-600 to-teal-700' : ' from-red-600 to-pink-700'}`}>
 ...
 className="py-6 rounded-2xl bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 flex flex-col items-center gap-1 hover:bg-red-200 dark:hover:bg-red-900/50"
 >
 ...
 className="py-6 rounded-2xl bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 flex flex-col items-center gap-1 hover:bg-green-200 dark:hover:bg-green-900/50"
 >
 <div className="flex items-center gap-2 mb-1">
 ...
 <div key={entry.id} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50 dark:hover:bg-slate-700 group">
 ...
 className="p-2 text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900 rounded-lg"
 title="Edit"
 >
 <Edit size={16} />
 </button>
 ...
 className="p-2 text-slate-600 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg"
 title="Delete"
 >
 <Trash2 size={16} />
 </button>
 ...
 {entries?.length === 0 && (
 <div className="p-10 text-center flex flex-col items-center gap-3 text-slate-600">
