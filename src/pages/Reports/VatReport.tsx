...
const VatReport: React.FC = () => {
    ...
    return (
        <div className={`space-y-6 animate-in fade-in duration-500 transition-opacity ${loading ? 'opacity-50 pointer-events-none select-none' : ''}`}>
                    ...
                    <div className="bg-slate-100 dark:bg-slate-700 p-1 rounded-lg flex">
                        {periods.map((p: any) => (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all ${period === p.id && !startDate
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <div className="p-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 flex justify-between items-center">
                        ...
                        <span className="text-sm font-bold text-slate-500">{t('reports.vat')}</span>
                    </div>
                    <div className="p-0">
            ...
            {/* Total Footer */}
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl p-6 shadow-lg flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
